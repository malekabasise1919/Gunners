 ...
 */
final class Version20220221213206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD address VARCHAR(255) DEFAULT NULL, ADD code_postal INT DEFAULT NULL');
    }
