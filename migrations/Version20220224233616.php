 ...
 */
final class Version20220224233616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image_name VARCHAR(255) NOT NULL, DROP photo');
    }
