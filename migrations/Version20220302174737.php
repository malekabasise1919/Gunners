 ...
 */
final class Version20220302174737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD statut VARCHAR(255) NOT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE date_de_reclamation date_de_reclamation DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation DROP statut, CHANGE projet_id projet_id INT NOT NULL, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date_de_reclamation date_de_reclamation DATE NOT NULL');
