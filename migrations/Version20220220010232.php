 ...
 */
final class Version20220220010232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture CHANGE id id VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE transaction CHANGE facture_id facture_id VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE facture_id facture_id INT DEFAULT NULL, CHANGE type type VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE statut statut VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
