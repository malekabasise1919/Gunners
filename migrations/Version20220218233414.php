 ...
 */
final class Version20220218233414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD bids INT DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL');
    }
